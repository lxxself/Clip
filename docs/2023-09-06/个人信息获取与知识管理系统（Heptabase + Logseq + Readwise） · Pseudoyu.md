---
id: 313d86aa-1a25-42e4-a8ee-20766841f8a5
---

# 个人信息获取与知识管理系统（Heptabase + Logseq + Readwise） · Pseudoyu
#Omnivore

[Read on Omnivore](https://omnivore.app/me/heptabase-logseq-readwise-pseudoyu-18a66243fe8)
[Read Original](https://www.pseudoyu.com/zh/2023/09/05/my_personal_pkm_input_output_system)

## 前言

![yu_blog_my_pkm_system](https://proxy-prod.omnivore-image-cache.app/0x0,s_ScN16MLKjUAm9DjG2xBpn9s14T7KkuXXc80atl_Rv0/https://image.pseudoyu.com/images/yu_blog_my_pkm_system.png)
...
![logseq_random_thoughts](https://proxy-prod.omnivore-image-cache.app/0x0,sW2QEwy_lW1zDpqYh-OBDClazoE6nGWwbEgCh3db8zRo/https://image.pseudoyu.com/images/logseq_random_thoughts.png)
...
![readwise_reader_feeds](https://proxy-prod.omnivore-image-cache.app/0x0,sot_eAivm7kdOS2HFGWtkrkspusC0PrAezIBPQzdKMhM/https://image.pseudoyu.com/images/readwise_reader_feeds.png)
...
![readwise_chrome_extension](https://proxy-prod.omnivore-image-cache.app/0x0,s3AT62zBkN3lZXVqrNEg0HeRHqZlS0dmhsB_FNWnfnrc/https://image.pseudoyu.com/images/readwise_chrome_extension.png)

如果是自己感兴趣的一些文章，则会通过 Readwise 的 Chrome 插件进行阅读或保存。这部分我给自己的要求是每篇文章都要打上标签和 notes，notes 中主要描述为什么要读这篇文章。

![readwise_chrome_extension_highlight](https://proxy-prod.omnivore-image-cache.app/0x0,s8B2fJMnlztiFbqrFKcyX5E-9hfyW8_dKyzIfVPQRZSA/https://image.pseudoyu.com/images/readwise_chrome_extension_highlight.png)
...
![pinboard_bookmark](https://proxy-prod.omnivore-image-cache.app/0x0,sSCPcH2gHvygTfA3eRE5DWOubbBSq9A-7rafc3t69lhk/https://image.pseudoyu.com/images/pinboard_bookmark.png)
...
![wechat_reader_sync_readwise](https://proxy-prod.omnivore-image-cache.app/0x0,sjIzlbTvtBpddOBz9CCqS3DKV9Xumsj9bP8dYvxsIMQo/https://image.pseudoyu.com/images/wechat_reader_sync_readwise.png)
...
![wechat_reader_to_readwise](https://proxy-prod.omnivore-image-cache.app/0x0,sM96uW5hjzJ7-Z0aDRd6c6ECvobWsveHOtgKaXF_BsVw/https://image.pseudoyu.com/images/wechat_reader_to_readwise.png)
...
![pama_framework](https://proxy-prod.omnivore-image-cache.app/0x0,s5sE-w2VWDAqkvb6snLG7wreL3sRb1vnYtVIsAlBuPQE/https://image.pseudoyu.com/images/pama_framework.jpg)
...
![logseq_tag_system](https://proxy-prod.omnivore-image-cache.app/0x0,sC77UNPA_BUy0QQ4Sv8WJ2nnODhl6lV1ynmM3JjiNJ70/https://image.pseudoyu.com/images/logseq_tag_system.png)
...
![para_logseq_graph](https://proxy-prod.omnivore-image-cache.app/0x0,sRC-yTsMAshnL63bTjIFyTx0DBabaOnkG_PTlP4y5APc/https://image.pseudoyu.com/images/para_logseq_graph.png)
...
![logseq_sync_readwise_sample_page](https://proxy-prod.omnivore-image-cache.app/0x0,s6JJmQkWLxqbeMmBNMmJZkWHE5vx5X7TQU4a2ZsrK3VU/https://image.pseudoyu.com/images/logseq_sync_readwise_sample_page.png)
...
![heptabase_map_overview](https://proxy-prod.omnivore-image-cache.app/0x0,spuGC-wmj_-tNhsDv73761wh6-8kef9h_4cl2xxSRJUA/https://image.pseudoyu.com/images/heptabase_map_overview.png)

其中 Map 可以看作是我们 Second Brain 的整个空间，里面可以装各种白板，我建立了五个白板来作为第一层级 Tag。

![heptabase_whiteboard_overview](https://proxy-prod.omnivore-image-cache.app/0x0,sL52jpEwbYn3BLDrmR8n12Y79bel21Dnf-y7v7Epbj3o/https://image.pseudoyu.com/images/heptabase_whiteboard_overview.png)
...
![heptabase_chiangmai_trip](https://proxy-prod.omnivore-image-cache.app/0x0,s-EBQA5HDqK9kQSd4vnVyyXpJWCv8bPRzLQmJLs65wAk/https://image.pseudoyu.com/images/heptabase_chiangmai_trip.png)
...
![yu_twitter_profile](https://proxy-prod.omnivore-image-cache.app/0x0,sROV7saE9-KNdkyUjS0hj0Vvb-6-rlE6zZ6UIVdgs1mU/https://image.pseudoyu.com/images/yu_twitter_profile.png)

其中 Twitter 「[pseudo\_yu](https://twitter.com/pseudo%5Fyu)」是我最主要的无结构化的信息输出渠道，有时候是一些关于新技术的想法、关于工作的感受、与朋友相见的心情或是一张可爱的猫猫图，都构成了我输出，也对应着我输入中那些随机想法的快速产出。

其中，Twitter 上认识的朋友也给我带来了很多温暖。

### 长文

![yu_blog_homepage](https://proxy-prod.omnivore-image-cache.app/0x0,sJtQGYIz_6Bfsk3BCNKYTc7CwZ5gy87wcMEDHcmTsPQM/https://image.pseudoyu.com/images/yu_blog_homepage.png)
...
![yu_telegram_channel_screenshot](https://proxy-prod.omnivore-image-cache.app/0x0,sHtTdJdlFWv71LdS6vAC5KenOaw2owLUVX8kQuweQ9lM/https://image.pseudoyu.com/images/yu_telegram_channel_screenshot.png)
...
![yu_xlog_profile](https://proxy-prod.omnivore-image-cache.app/0x0,sv13ATiPAfQGQWf1Cg0pOHT6zXBZcMY8orXMfhhAbiEs/https://image.pseudoyu.com/images/yu_xlog_profilea6f9af1d5482abc7.png)
...
![yu_sync_profile](https://proxy-prod.omnivore-image-cache.app/0x0,sa7lpjL3GViKl8RpXzjYeAnZQqKllaVJiogi7X1PLAkg/https://image.pseudoyu.com/images/yu_sync_profile.png)
...
[周报 #45 - 读书笔记、知识管理与双城生活](https://www.pseudoyu.com/zh/2023/09/04/weekly%5Freview%5F20230904/)

[周报 #38 - Foundry 合约测试、Logseq 任务管理与 Surge Ponte 远程开发](https://www.pseudoyu.com/zh/2023/04/30/weekly%5Freview%5F20230430/)

[周报 #25 - 基于 Crossbell 的个人信息输出与同步系统（重构）](https://www.pseudoyu.com/zh/2023/01/09/weekly%5Freview%5F20230109/)

[个人工具箱（2022 年 5 月）](https://www.pseudoyu.com/zh/2022/05/08/personal%5Ftools%5Fin%5F2022%5Fmay/)
...
> * GitHub，也是日常刷了，看一些好的项目，也用列表在管理 Star。
> * Spotify，好听的歌会标注一下。
> * 豆瓣，记录自己的书籍、剧集、电影、动漫和游戏，也是重度使用了，也在尝试每一个看过/玩过的作品都写一下自己的评价。 [⤴️](https://omnivore.app/me/heptabase-logseq-readwise-pseudoyu-18a66243fe8#35cb49af-3f8f-4cff-931e-08681062b0a2) 
